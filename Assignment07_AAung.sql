...
-- 2017-08-17,AAung,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_AAung')
	 Begin 
	  Alter Database [Assignment07DB_AAung] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_AAung;
	 End
	Create Database Assignment07DB_AAung;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_AAung;
...
Select * From vProductInventoriesWithPreviousMonthCountsWithKPIs (1)
	ORDER BY 1, 2, 3;
Select * From vProductInventoriesWithPreviousMonthCountsWithKPIs (0)
	ORDER BY 1, 2, 3;
Select * From vProductInventoriesWithPreviousMonthCountsWithKPIs (-1)
	ORDER BY 1, 2, 3;
